// 생성자 함수
// 전달된 매개변수가 없으면 open에 디폴트로 false값이 들어감
// 매개변수의 디폴트값 설정
function Drawer(el, open = false) {
  this.el = el;
  this.isOpen = open;
  // 객체의 원형에 assign메소드는 하나 이상의 객체로부터
  // 대상 객체로 속성을 복사할 때 사용한다.
  // 두 번째 매개변수는 객체의 속성을 복사해서 첫번째 매개변수의 객체에
  // 속성을 추가한 뒤 첫번재 매개변수의 객체를 반환한다.

  // 다른 객체의 속성을 복사해서 새로운 객체를 생성한다. --> 반환
